[root@laoyang]/home/laoyang# ifconfig enp2s8 192.168.66.88
[root@laoyang]/home/laoyang# iptables -F
[root@laoyang]/home/laoyang# iptables -P FORWARD ACCEPT
[root@laoyang]/home/laoyang# iptables -P INPUT ACCEPT
[root@laoyang]/home/laoyang# iptables -t nat -A POSTROUTING -o wlp16s0 -j MASQUERADE
[root@laoyang]/home/laoyang# echo 1 > /proc/sys/net/ipv4/ip_forward 
[root@laoyang]/home/laoyang# ifconfig 
